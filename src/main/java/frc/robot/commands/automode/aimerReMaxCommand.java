...
public class aimerReMaxCommand extends CommandBase {

  private final limelightAimerSystem limelightaimersystem;
 
  public aimerReMaxCommand(limelightAimerSystem limelightaimersubsystem) {
  ...
  @Override
  public void execute() {
    limelightaimersystem.runMaxlimelightAimer();
  }
