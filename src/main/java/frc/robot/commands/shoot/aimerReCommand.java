...
public class aimerReCommand extends CommandBase {

  private final limelightAimerSystem limelightaimersystem;
 
  public aimerReCommand(limelightAimerSystem limelightaimersubsystem) {
  ...
  @Override
  public void execute() {
    limelightaimersystem.runlimelightAimer();
  }
